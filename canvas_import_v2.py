...
Use:
- <details><summary>...</summary><div>...</div></details> for accordions.
- <blockquote> for callouts.
- <ul><li> for bullets starting with '-'.
- Quiz questions should detect <question><multiple choice> blocks and convert to Canvas quiz items.
- Keep paragraphs, styling, and structure as-is.
